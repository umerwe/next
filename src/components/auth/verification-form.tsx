    ...
    return (
        <div className="bg-white rounded-md shadow-2xl px-4 py-8 sm:py-10 sm:px-6 w-full lg:w-[330px]">
            ...
            <div className="mb-8 text-center">
                <h1 className="text-2xl font-bold text-gray-900 mb-1">Account Verification</h1>
                <p className="text-gray-custom text-sm">{"Enter Email/Phone Number to verify your account"}</p>
            </div>
