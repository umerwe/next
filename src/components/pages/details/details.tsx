            ...
            <div className='px-3'>
                ...
                <div className="mt-8">
                    ...
                    <div className="flex items-center justify-between max-w-100 space-x-3">
                        ...
                        <div className='border-2 border-t-aqua border-r-aqua border-b-blue
           border-l-blue flex items-center justify-center mb-2 w-10 h-10 rounded-md cursor-pointer'>
