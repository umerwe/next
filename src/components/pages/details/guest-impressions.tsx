  ...
  return (
    <div className="mb-6">
      ...
      <div className="flex gap-4 items-start justify-center">
        {/* AI Summary Section */}
        <div className="p-4 flex-1 border border-gray-200 rounded-lg bg-white max-w-sm">
        ...
        <div className="flex gap-5 flex-1">
          {property.reviews.map((review) => (
            <div
              key={review.id}
              className="border border-gray-200 rounded-lg p-4 mb-4 max-w-sm bg-white flex-1"
            >
